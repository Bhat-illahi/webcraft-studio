...
function createParticles() {
  ...
  // Intelligent Density: 160 on mobile for performance, 500 on desktop for WOW
  const particleCount = window.innerWidth < 768 ? 160 : 500;
  ...
  const baseRadius = window.innerWidth < 768 ? 35 : 150;
